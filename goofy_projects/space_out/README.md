This script literally just takes a file name and a string and spits out a file by that filename with the given string having a space in between each character (except the last one)
